...
class FiltroSalasScreen extends React.Component {
  ...
  render() {
    ...
    const {funVerSalaFiltro, ver_sala_filtro, data_detalle, dataSala,funSalasOrdenKeys,funSalasOrdenAscendencia,  sala_orden_asc, sala_orden_key, status } = this.props;
      ...
      <TouchableOpacity style={styles.view_close} onPress={()=>funVerSalaFiltro(!ver_sala_filtro)} >
        ...
        <ScrollView
          ...
          <View style={styles.scrollableModalContent1}>
            ...
            <TouchableOpacity style={styles.view_close} onPress={()=>funSalasOrdenKeys('otro')} >
             <Icon
              name={'ios-arrow-down'}
              size={30}
              color={'#bbb'}
          ...
          <TouchableOpacity style={styles.view_close} onPress={()=>funSalasOrdenAscendencia(!sala_orden_asc)} >
             <Icon
              name={'ios-arrow-down'}
              size={30}
              color={'#bbb'}
