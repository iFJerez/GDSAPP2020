...
import {StyleSheet, Text, View, Share, Button, Alert, Linking} from 'react-native';
...
class ModalScreen extends React.Component {
  ...
  componentDidMount(){
    //alert(JSON.stringify(this.props.dataSala))
  }

  onShare = async () => {
    const url = REACT_ICON
    ...
    shareToWhatsApp = (text) => {
      ...
      Linking.openURL(`https://wa.me/56975220361?text=Me%20gustaría%20saber%20el%20precio%20del%20coche`);
  };
  ...
  render() {
    return (
       <>
            ...
            <Text style={styles.text}>
                HOLA MUNDO SOY EL TEXTO Nuevo
            </Text>

            <Button onPress={this.onShare} title="Share" />
            <Button onPress={()=>this.shareToWhatsApp('Su sala Bajo 30%!"·$%&/()=')} title="wahsap" />
